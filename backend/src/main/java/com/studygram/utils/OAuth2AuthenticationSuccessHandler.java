...
import static com.studygram.mapper.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.studygram.mapper.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        // DB 저장
        UserRefreshToken userRefreshToken = userRefreshTokenMapper.findByClientId(userInfo.getId());
        ...
        return UriComponentsBuilder.fromUriString(targetUrl)
                ...
                .queryParam("userIdx", userRefreshTokenMapper.findUserIdxByClientId(userInfo.getId()))
                .build().toUriString();
    }
